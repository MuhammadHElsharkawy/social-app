...
export class PostsFilterBtnComponent {
  ...
  buttonClasses = computed(() =>
    this.isActive()
      ...
      : 'bg-slate-50 text-slate-700 hover:bg-slate-100 lg:bg-transparent lg:text-slate-600 dark:bg-slate-800/80 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 lg:dark:bg-transparent',
  );
